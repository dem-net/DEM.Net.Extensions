...
namespace SampleApp
{
    ...
    public class Location3DModelSettings
    {
        ...
        public Func<Location3DModelSettings, Location3DModelRequest, string> ModelFileNameGenerator { get; set; } = (s,r) => $"{r.Id}_{s.Dataset.Name}_{(s.OsmBuildings ? "Osm" : "")}{(s.GenerateTIN ? "TIN" : "")}{s.ImageryProvider?.Name}.glb";
